...
| RF-014 | Conteúdo e versões           | contratos estritos, API tenant-scoped, versões imutáveis e tela de criação/acompanhamento                                                                | G3   |
| RF-015 | Aprovar conteúdo             | submissão cria approval versionado; decisão AAL2 impede autoaprovação e aplica o estado do conteúdo                                                      | G3   |
| RF-016 | Agendar/publicar             | calendário real, cron, fila exclusiva, tentativas e publicação Google Business com falha explícita                                                       | G3   |
...
| RF-020 | Alertas                      | API e tela reais com reconhecimento/resolução versionados e responsável                                                                                  | G3   |
| RF-021 | Fechamento e snapshot        | período único, job, snapshot imutável e indicadores consolidados                                                                                         | G4   |
| RF-022 | HTML e PDF                   | HTML canônico e PDF derivado renderizados no Storage privado com acesso assinado                                                                         | G4   |
...
| RF-025 | Uso e custo                  | agregação mensal real por provedor e tela de custos                                                                                                      | G2   |
| RF-026 | Orçamento                    | edição de limites por provedor com validação de aviso/bloqueio e vigência                                                                                | G2   |
...
| RF-033 | Brand kit                    | API/tela versionadas para voz, públicos, claims e tokens visuais; um kit ativo por tenant                                                                | G3   |
...
| RF-039 | Busca e navegação            | app shell persistente, rota ativa, gaveta móvel acessível, feedback de transição, skeletons e movimento reduzível; critérios em `docs/ux-performance.md` | G0   |
